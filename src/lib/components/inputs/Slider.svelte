...
<div class="relative w-full">
        ...
        <div class="flex items-center text-sm text-textColor">
            ...
            <div class="flex items-center">
                <input
                    ...
                    {max}
                    {step}
                    class="ml-2 w-12 rounded border border-neutral-300 bg-backgroundColor text-center text-xs text-textColor" />
    ...
    <input
        ...
        class="h-1 w-full cursor-pointer appearance-none rounded-full bg-neutral-400 [&::-webkit-slider-thumb]:h-2 [&::-webkit-slider-thumb]:w-2 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primaryShade-200 [&::-webkit-slider-thumb]:shadow-md hover:[&::-webkit-slider-thumb]:bg-primaryShade-300"
    ...
    {#if tooltip}
        <div
            ...
            style:top={tooltipPosition ? tooltipSpacing : 'auto'}
            style:bottom={tooltipPosition ? 'auto' : tooltipSpacing}>
            {value}
            <div
                ...
                class="absolute left-1/2 -ml-1 border-x-4 border-solid border-primaryColor border-x-transparent">
            </div>
        </div>
    {/if}
</div>
