<script lang="ts">
    ...
    import { Workers } from '$lib/types/workers'
    ...
    let severity: Workers.BugSeverity = $state(Workers.BugSeverity.LOW)
    ...
    const handleSubmit = async (): Promise<void> => {
        ...
        const report: Workers.ReportData = {
            type: 'bug',
            description,
        }
