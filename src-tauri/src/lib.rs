...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::db::get_resolved_cache_by_imdb_id,
            commands::db::create_resolved_cache,
            commands::db::delete_all_resolved_cache,
            commands::db::delete_resolved_cache_by_infohash,
